          ...
          <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
              <fieldset>
                  ...
                  <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="phone" value="<?php echo $phone; ?>" id="input-name" class="form-control" />
                          <?php if ($error_phone) { ?>
                  ...
                  <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="country" value="<?php echo $country; ?>" id="input-name" class="form-control" />
                  ...
                  <div class="form-group required">
                      ...
                      <div class="col-sm-10">
                          <input type="text" name="city" value="<?php echo $city; ?>" id="input-name" class="form-control" />
                          <?php if ($error_city) { ?>
