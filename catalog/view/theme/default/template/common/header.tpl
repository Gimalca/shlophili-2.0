...
<header>
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
          <div id="logo" class=" center-block center">
          <?php if ($logo) { ?>
          <a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" class="img-responsive center center-block" /></a>
          <?php } else { ?>
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse">
      <ul class="nav navbar-nav">
                ...
                <li>
                    <div class="image">
                        <a href="<?php //echo $child['href']; ?>">
                            <img src="<?php //echo $child['image']; ?>" title="<?php //echo $child['name']; ?>" alt="<?php //echo $child['name']; ?>" />
                        </a>
                    </div>
        ...
        <li class="dropdown ">
            ...
            <div class="dropdown-menu show-marca">
                <div class="dropdown-inner">
