...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$mail->setSubject('Comentario desde shlophili.com');
			
                        $body = '<br><b>Nombre:</b> '. $this->request->post['name'].' '.$this->request->post['lastname']
                                .='<br><br><b>Email: </b>'.$this->request->post['email']
                                .='<br><br><b>Teléfono: </b>'.$this->request->post['phone']
                                .='<br><br><b>País: </b>'.$this->request->post['country']
                                .='<br><br><b>Ciudad: </b>'.$this->request->post['city']
                                .='<br><br><b>Comentario: </b>'.$this->request->post['enquiry'];
		...
		$data['entry_city'] = $this->language->get('entry_city');
                $data['entry_enquiry'] = $this->language->get('text_comment');
